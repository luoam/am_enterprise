...
d + "px").css("background-color", a.isDark(e, i) ? h.foreground : h.background).appendTo(f)
        ...
        $(function () {  
			...
			var qr_site = 'http://'+window.location.hostname+':'+window.location.port+"/mobile";
	
            jQuery('#qr_output').qrcode(utf16to8(qr_site)); 
			jQuery('#qr_output1').qrcode(utf16to8(qr_site)); //澶氫釜浜岀淮鐮佹椂鐢ㄥ埌
        })      