...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="invoice no-margin">
      ...
      <div class="row">
          <div class="col-xs-12">
          <h3 class="page-header">删除链接</h3>
          </div>
          <div class="col-xs-12">
            <article class="page-container">
                    <form class="form form-horizontal" id="form-link-del" onsubmit="return links_del()">
...
function links_del()
    {
      ...
      var id = <?=$id?>;
        ...
        $.ajax({
        type:"POST",
        url:"<?=$site_url?>/admin_links/del_save",
        data:datastring,
        dataType:"json",
