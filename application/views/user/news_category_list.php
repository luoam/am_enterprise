			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="text-l"><?=$category['name']?></td>
                                        <td class="f-14"><a title="编辑" href="<?=$site_url?>/user_news/category_edit/<?=$category['id']?>" style="text-decoration:none"><i class="glyphicon glyphicon-pencil"></i></a> <a title="删除" href="<?=$site_url?>/user_news/category_del/<?=$category['id']?>" class="ml-5" style="text-decoration:none"><i class="glyphicon glyphicon-trash"></i></a></td>
				</tr>
                                <?php endforeach;?>
			</tbody>
		</table>
