...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="invoice no-margin">
      ...
      <div class="row">
          <div class="col-xs-12">
          <h3 class="page-header">修改评论</h3>
          </div>
          <div class="col-xs-12">
            <article class="page-container">
                    <form class="form form-horizontal" id="form-comment-edit"  onsubmit="return comment_edit()">
...
function comment_edit()
    {
      ...
      var id = <?=$comment['id']?>;
//        datastring = datastring + 'author_name=' + author_name + '&author_email=' + author_email + '&author_url=' + author_url + '&message=' + message +'&id=' + id;
        datastring = {
        ...
        $.ajax({
        type:"POST",
        url:"<?=$site_url?>/admin_comment/edit_save",
        data:datastring,
        dataType:"json",
