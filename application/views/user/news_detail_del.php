...
<link rel="stylesheet" href="<?=$base_url?>static/plugins/select2/select2.min.css">
 <title><?=$site['name']?> | <?=$user_site['name']?>删除文章</title>
</head>
      ...
      <div class="row">
          ...
          <div class="col-xs-12">
            <article class="page-container">
                    <form class="form form-horizontal" id="form-article-edit" onsubmit="return news_del_save()">
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-10"> 
                                            <script id="data" name="data" type="text/plain" style="width:100%;height:400px;"><?=$news_detail['content']?></script> 
                                    </div>
                            </div>
                            <div class="form-group">
...
function news_del_save()
    {
      var datastring ='';
        ...
        $.ajax({
        type:"POST",
        url:"<?=$site_url?>/user_news/news_del_save",
        data:datastring,
        dataType:"json",
