...
<link rel="stylesheet" href="<?=$base_url?>static/plugins/select2/select2.min.css">
 <title><?=$site['name']?> | <?=$user_site['name']?>添加产品</title>
</head>
                    ...
                    <form class="form form-horizontal" id="form-article-add">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="banner_1">图一：</label>
                                    <div class="col-sm-10">
                                        ...
                                        <input name="banner_1" id="banner_1" value="" class="form-control" type="text">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="banner_2">banner图二：</label>
                                    <div class="col-sm-10">
                                        ...
                                        <div class="input-group">
                                        <input name="banner_2" id="banner_2" value="" class="form-control" type="text">
                                        <span class="input-group-btn">
                            ...
                            <div class="form-group">
                                    <div class="col-xs-offset-4 col-sm-offset-2">
                                            <button onClick="return products_add_save();" class="btn btn-primary" type="submit">提交</button>
                                    </div>
                            </div>
                    </form>
            </article>
...
function products_add_save()
    {
      var datastring ='';
      var title = $("#title").val();
      var img1 = $("#banner_1").val();
      var img2 = $("#banner_2").val()
      ...
      }else
      {
        ...
        $.ajax({
        type:"POST",
        url:"<?=$site_url?>/user_products/products_add_save",
        data:datastring,
        dataType:"json",
