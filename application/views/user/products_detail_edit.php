...
<link rel="stylesheet" href="<?=$base_url?>static/plugins/select2/select2.min.css">
 <title><?=$site['name']?> | <?=$user_site['name']?>修改产品</title>
</head>
                    ...
                    <form class="form form-horizontal" id="form-article-add">
                            ...
                            <div class="form-group">
                                    <div class="col-xs-offset-4 col-sm-offset-2">
                                            <button onClick="return products_edit_save();" class="btn btn-primary" type="submit">提交</button>
                                    </div>
                            </div>
                    </form>
            </article>
...
function products_edit_save()
    {
      ...
      }else
      {
        ...
        $.ajax({
        type:"POST",
        url:"<?=$site_url?>/user_products/products_edit_save",
        data:datastring,
        dataType:"json",
