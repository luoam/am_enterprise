...
<link rel="stylesheet" href="<?=$base_url?>static/plugins/select2/select2.min.css">
 <title><?=$site['name']?> | <?=$user_site['name']?>添加栏目</title>
</head>
      ...
      <div class="row">
          ...
          <div class="col-xs-12">
            <article class="page-container">
                    <form class="form form-horizontal" id="form-category-add" onsubmit="return category_save()">
...
//        datastring = datastring + 'categoryname=' + categoryname + '&upcategory=' + upcategory + '&description=' + description + '&keywords=' + keywords + '&flag=' + flag;
        ...
        $.ajax({
        type:"POST",
        url:"<?=$site_url?>/user_products/category_add_save",
        data:datastring,
        dataType:"json",
